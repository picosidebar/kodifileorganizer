...
public class Organizer {
    ...
    private static final Properties props = Config.getProps();
    private static final String[] BAD_EXTENSIONS = props.getProperty("badExtensions").split("#");
    private static final String[] BAD_FILES = props.getProperty("badFiles").split("#");
    private static final String OMDBApiKey = props.getProperty("omdbApiKey");
    private static final String OMDBUrl = props.getProperty("omdbUrl");

    private static final File logFile = new File(props.getProperty("logFile"));
    private static final File errorLogFile = new File(props.getProperty("errorFile"));
    private static final File rootPath = new File(props.getProperty("rootPath"));
